...
from .agents import SlidingAgent
...
class Action:
    ...
    """
    def __init__(self, id_: list, parameters: list):
        """"
...
class BaseEnv(gym.Env):
    ...
    def __init__(
        ...
        self.action_space = spaces.Tuple((spaces.MultiDiscrete([3]),
    ...
    def step(self, raw_action: Tuple[list, list]) -> Tuple[list, float, bool, dict]:
